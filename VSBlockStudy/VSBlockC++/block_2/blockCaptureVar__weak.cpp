...
struct __main_block_impl_0 {
  ...
  __weak typeof (object) weakO;
  __main_block_impl_0(void *fp, struct __main_block_desc_0 *desc, __weak typeof (object) _weakO, int flags=0) : weakO(_weakO) {
...
static void __main_block_func_0(struct __main_block_impl_0 *__cself) {
  __weak typeof (object) weakO = __cself->weakO; // bound by copy

        NSLog((NSString *)&__NSConstantStringImpl_blockCaptureVar_m_0,weakO);
    }
static void __main_block_copy_0(struct __main_block_impl_0*dst, struct __main_block_impl_0*src) {_Block_object_assign((void*)&dst->weakO, (void*)src->weakO, 3/*BLOCK_FIELD_IS_OBJECT*/);}

static void __main_block_dispose_0(struct __main_block_impl_0*src) {_Block_object_dispose((void*)src->weakO, 3/*BLOCK_FIELD_IS_OBJECT*/);}
